...
export default function AdsBridge() {
  ...
  return <section className="content">
    ...
    <div style={{ marginTop: 18 }}><Card><Badge>Shared mapping</Badge> <span className="muted" style={{ marginLeft: 8 }}>Keep CommerceAutomation as the growth/integration layer; PriyasaCore remains the commerce source of truth.</span><div style={{ marginTop: 14 }}><Button onClick={() => window.location.assign(base + '/integrations')}><RefreshCw size={14}/> Open integrations</Button></div></Card></div>
  </section>;
}
