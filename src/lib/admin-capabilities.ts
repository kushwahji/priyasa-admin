...
export const ADMIN_CAPABILITIES:AdminCapability[]=[
 ...
 {key:'marketing',label:'Marketing & Promotions',description:'Manual campaigns, FCM, email, WhatsApp and RCS orchestration, automations, coupons and performance.',prefixes:['/admin/marketing','/admin/promotions','/admin/merchandising'],path:'/marketing'},
