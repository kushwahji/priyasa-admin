...
export const API_ROUTES = {
 ...
 ads:{status:'/admin/ads/status',assets:'/admin/ads/assets',adAccount:'/admin/ads/assets/ad-account',accounts:'/admin/ads/accounts',campaigns:'/admin/ads/campaigns',adsets:'/admin/ads/adsets',creatives:'/admin/ads/creatives',ads:'/admin/ads/ads',audiences:'/admin/ads/audiences',retarget:(id:string|number)=>`/admin/ads/audiences/${id}/retarget`,insights:'/admin/ads/insights',aiGenerate:'/admin/ads/ai/generate'},
 ...
 events:{list:'/admin/events',detail:(id:string|number)=>`/admin/events/${id}`},
 ops:{metrics:'/admin/ops/metrics',audit:'/admin/ops/audit'},
