...
export const API_ROUTES = {
 ...
 settings:'/admin/settings', analytics:'/admin/analytics', audit:'/admin/audit-logs',
 ...
 integrations:{list:'/admin/integrations',woocommerceStatus:'/admin/integrations/woocommerce/status',woocommerceSync:'/admin/integrations/woocommerce/sync',metaStatus:'/admin/integrations/meta/status',metaConnect:'/admin/integrations/meta/connect'},
